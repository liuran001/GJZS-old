...
<group title="解决方法①">
    <page html="https://han.lanzous.com/b03bjaped">
        <title>下载搞机助手-CMD版.apk</title>
        <desc>点击跳转蓝奏云下载搞机助手-CMD版安装修复，推荐直接在下面安装&#x000A;如果安装失败了在手动安装，手动安装未核心破解需要卸载当前版本才能安装搞机助手-CMD版，下载安装完后打开搞机助手-CMD版，最后再安装搞机助手一切即可正常使用</desc>
        <summary>链接：https://han.lanzous.com/b03bj0djg&#x000A;密码：gjzs</summary>
    </page>
    <action interruptible="false">
        <title>安装搞机助手-CMD版</title>
        <desc>已下载完成后请点击此处安装搞机助手-CMD版，如果未能自动重启搞机助手请手动打开搞机助手-CMD版</desc>
        <set>. ./Install_Command.sh -apk</set>
    </action>
</group>
